# Makes a campaign
#./drseus.py --serial /dev/ttyUSB1 --prompt safeword --jtag_ip rpi3open.local --timeout 40000 new --arch a9 -c unused -t 1 -o output.txt

./drseus.py --serial /dev/ttyUSB1 --baud 460800 --prompt safeword --jtag_ip rpi3open.local --timeout 40000 new --arch a9 -c unused -t 1 -o output.txt
